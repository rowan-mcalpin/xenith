 ...
 * strictly "constants" by the normal definition, but they are constant over the course of an OpMode. The name of this
 * class is open to additional suggestions.
 */
object Constants {
    /**
